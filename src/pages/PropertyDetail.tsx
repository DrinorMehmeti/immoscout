...
import { MapPin, Heart, Share, ArrowLeft, Users, MessageSquare } from 'lucide-react';
          ...
          <div className="lg:col-span-1">
            ...
            <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-md`}>
              ...
              <div className="mt-6 flex space-x-2">
                ...
                >
                  <Heart className={`h-5 w-5 mr-2 ${isFavorite ? 'fill-pink-700 dark:fill-pink-300' : ''}`} />
            ...
            <div className={`mt-6 ${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-md`}>
              ...
              {!isPropertyOwner ? (
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center">
                          <div className="h-12 w-12 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold">
                            {property.owner_id.charAt(0).toUpperCase()}
                          </div>
                          <div className="ml-4">
                        ...
                        <div className="border-t border-b py-4 space-y-4">
                          {!authState.isAuthenticated ? (
                            <div className={`p-4 rounded-md ${darkMode ? 'bg-yellow-900/20 text-yellow-300' : 'bg-yellow-50 text-yellow-800'}`}>
                              <p>Ju duhet të jeni të kyçur për të kontaktuar pronarin</p>
                              <Link 
                                to="/login" 
                                className={`mt-2 inline-block font-medium ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-800'}`}
                              >
                                Kyçuni këtu
                              </Link>
                            </div>
                            ...
                            <>
                              <button 
                                ...
                                className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-md font-medium"
                              >
                ...
                <div className={`p-4 rounded-md ${darkMode ? 'bg-blue-900/20 text-blue-300' : 'bg-blue-50 text-blue-800'}`}>
                  <p className="font-medium">Kjo është prona juaj</p>
                  <p className="mt-2">Ju mund të shihni statistikat e pronës dhe të menaxhoni kërkesat e kontaktit në panelin tuaj.</p>
                </div>
              )}
            </div>
          </div>
