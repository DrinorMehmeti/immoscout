...
export default function Signup() {
  // Modified to follow your existing codebase's naming convention
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Submitting signup form:', { name, email, password, newsletter });
    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-1 flex-col justify-center px-4 py-10 lg:px-6">
        ...
        <Card className="mt-4 sm:mx-auto sm:w-full sm:max-w-md">
          <CardContent>
            {error && (
              <div className="mb-4 p-4 rounded-md bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300">
                <p>{error}</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mt-2 flex items-start">
                ...
                >
                  Regjistrohu në buletinin tonë informativ
                </Label>
              </div>
